...
def get_datasets(config_data):
    ...
    train_data_loader_lst = get_dataloader(imgs_root_dir, root_train, config_data)
    val_data_loader_lst = get_dataloader(imgs_root_dir, root_val, config_data)
    test_data_loader_lst = get_dataloader(imgs_root_dir, root_test, config_data)
